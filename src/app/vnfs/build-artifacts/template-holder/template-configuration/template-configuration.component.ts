...
export class GoldenConfigurationComponent implements OnInit {
    ...
    retrieveTemplateFromAppcSubscription: Subscription;
    ...
    ngOnDestroy() {
        ...
        if (this.retrieveTemplateFromAppcSubscription) { this.retrieveTemplateFromAppcSubscription.unsubscribe(); }
    }
    ...
    retrieveTemplateFromAppc() {
        ...
        if (refObj && refObj != undefined) {
            ...
            this
                .retrieveTemplateFromAppcSubscription = this.httpUtil.post({
